...
{
    static const char *countryCode[] = { "--","AP","EU","AD","AE","AF","AG","AI","AL","AM","AN","AO","AQ","AR","AS","AT","AU","AW","AZ","BA","BB","BD","BE","BF","BG","BH","BI","BJ","BM","BN","BO","BR","BS","BT","BV","BW","BY","BZ","CA","CC","CD","CF","CG","CH","CI","CK","CL","CM","CN","CO","CR","CU","CV","CX","CY","CZ","DE","DJ","DK","DM","DO","DZ",
...
{
    static const char *countryName[] =  {QT_TR_NOOP("N/A"),QT_TR_NOOP("Asia/Pacific Region"),QT_TR_NOOP("Europe"),QT_TR_NOOP("Andorra"),QT_TR_NOOP("United Arab Emirates"),QT_TR_NOOP("Afghanistan"),QT_TR_NOOP("Antigua and Barbuda"),QT_TR_NOOP("Anguilla"),QT_TR_NOOP("Albania"),QT_TR_NOOP("Armenia"),QT_TR_NOOP("Netherlands Antilles"),QT_TR_NOOP("Angola"),QT_TR_NOOP("Antarctica"),QT_TR_NOOP("Argentina"),QT_TR_NOOP("American Samoa"),QT_TR_NOOP("Austria"),QT_TR_NOOP("Australia"),QT_TR_NOOP("Aruba"),QT_TR_NOOP("Azerbaijan"),QT_TR_NOOP("Bosnia and Herzegovina"),QT_TR_NOOP("Barbados"),QT_TR_NOOP("Bangladesh"),QT_TR_NOOP("Belgium"),
                                    ...
                                    QT_TR_NOOP("Other"),QT_TR_NOOP("Aland Islands"),QT_TR_NOOP("Guernsey"),QT_TR_NOOP("Isle of Man"),QT_TR_NOOP("Jersey"),QT_TR_NOOP("Saint Barthelemy"),QT_TR_NOOP("Saint Martin")
                                   };
